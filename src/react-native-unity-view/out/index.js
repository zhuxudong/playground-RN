...
var MessageHandler = /** @class */ (function () {
    ...
    MessageHandler.prototype.send = function (data) {
        UIManager.dispatchViewManagerCommand(this.viewHandler, UIManager.UnityView.Commands.postMessage, ['UnityMessageManager', 'onRNMessage', messagePrefix + JSON.stringify({
            id: this.id,
            seq: 'end',
            name: this.name,
            data: data
